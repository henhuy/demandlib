...
latex_documents = [
    (
        "index",
        "demandlib.tex",
        u"demandlib Documentation",
        u"Uwe Krien, oemof developing group",
        "manual",
    ),
]
...
texinfo_documents = [
    (
        ...
        u"Uwe Krien",
        "demandlib",
        "Calculate time series of wind and pv power plants from weather data.",
        "Miscellaneous",
    ),
]
